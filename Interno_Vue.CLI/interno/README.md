...
7. На странице Project (\"Our Project\)
   - Реализована пагинация
   - Добавлены несколько произвольных статей, с описанием. По нажатию на кнопки в разделе «Tags» происходит сортировка статей по хештегам \"Bathroom\", \"Bed Room\", \"Kitchan\", \"LivingArea\".
...
9. Сайт выполнен в дестопной версии.
